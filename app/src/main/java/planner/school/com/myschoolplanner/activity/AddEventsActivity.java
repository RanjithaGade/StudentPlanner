 ...
 */
public class AddEventsActivity extends Activity implements View.OnClickListener{

    private EditText mTitleEt;
    private EditText mDescEt;
    private TextView mDateVal;
    private TextView mTimeVal;
    private ToggleButton mRsvpToggle;
    ...
    private void initializeViews() {
        ...
        mRsvpToggle = (ToggleButton)findViewById(R.id.going_toggle);
    ...
    private void save() {
        ...
        try {
            ...
            taskJson.put("rsvp",mRsvpToggle.isChecked());
    ...
    private void addTask(JSONObject newClass, Date date) throws  Exception{
        ...
        values.put(CalendarProvider.EVENT, "EVENT");
